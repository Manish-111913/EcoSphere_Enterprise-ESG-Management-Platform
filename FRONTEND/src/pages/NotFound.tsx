...
export default function NotFound() {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center font-sans antialiased">
      <div className="w-16 h-16 bg-primary-teal/10 text-primary-teal rounded-full flex items-center justify-center mb-6 shadow-sm border border-primary-teal/20">
        <HelpCircle className="h-8 w-8" />
      </div>
      <span className="text-[10px] bg-emerald-100 text-emerald-800 px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider mb-2">
        Error Code: 404
      </span>
      ...
      <p className="text-xs text-neutral-text-muted max-w-md mb-6 leading-relaxed">
        The requested resource or page cannot be resolved. It may be part of an unreleased module of the EcoSphere dashboard.
      </p>
      <button
